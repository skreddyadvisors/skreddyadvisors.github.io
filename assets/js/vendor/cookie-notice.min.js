...
function gdprCookieNotice(c) {
  ...
  function o() {
    ...
    (n.innerHTML = gdprCookieNoticeLocales[c.locale].always_on),
      ...
      t.remove(),
      c.performance &&
        (o.innerHTML += v("category.html", "cookie_performance")),
      ...
      u &&
        ((document.getElementById(a + "-cookie_performance").checked =
          u.performance),
        (document.getElementById(a + "-cookie_analytics").checked =
          u.analytics),
        (document.getElementById(a + "-cookie_marketing").checked =
          u.marketing)),
      (s = !0);
  }
  function h() {
        ...
        window.addEventListener("scroll", function e() {
          ...
          (o =
            ...
            25 < Math.floor((n / i) * 100) &&
              !l &&
              (l = !0) &&
              (k(), window.removeEventListener("click", e));
        }));
