!(function (i) {
  ...
  (t.prototype = {
    ...
    emptyFill: "rgba(255, 255, 255, 0.075)",
    animation: { duration: 1200, easing: "radialProgressEasing" },
      ...
      if (
        ...
        if (1 == s.length) this.arcFill = s[0];
          ...
          for (
            ...
            var c = s[d],
              u = d / (s.length - 1);
            i.isArray(c) && ((u = c[1]), (c = c[0])), h.addColorStop(u, c);
          }
          this.arcFill = h;
        }
      }
    ...
    drawAnimated: function (t) {
      var e = this,
        ...
        n = i(this.canvas);
      n.stop(!0, !1),
        a.trigger("radial-animation-start"),
        n
          ...
          .animate(
            ...
            i.extend({}, this.animation, {
              step: function (i) {
                ...
                e.drawFrame(n), a.trigger("radial-animation-progress", [i, n]);
              },
            })
          )
          .promise()
          .always(function () {
            a.trigger("radial-animation-end");
          });
    },
    ...
    (i.radialProgress = { defaults: t.prototype }),
    (i.easing.radialProgressEasing = function (i) {
      return i < 0.5
        ? 0.5 * (i *= 2) * i * i
        : 1 - 0.5 * (i = 2 - 2 * i) * i * i;
    }),
    (i.fn.radialProgress = function (e, a) {
      var n = "radial-progress",
        r = this.data(n);
      if ("widget" == e) {
        if (!r)
          throw Error(
