!(function (e, t) {
  ...
  function n(e) {
        ...
        function (e, r) {
          null === c[t] &&
            (r.forEach(function (e) {
              return s.onError(e.xhr, n, e.url);
            }),
    ...
    function l(e, r) {
      var s =
        ...
        a = {};
      return (
        (a.rules = (e.replace(t, "").match(n) || []).filter(function (e) {
      ...
      ? a.forEach(function (e, t) {
          ...
          if (l)
            r(n, {
              ...
              onSuccess: function (r, s, a) {
                var c = o(n);
                u(r, t, e, c);
              },
              onError: function (r, n, o) {
                (c[t] = ""), s.onError(r, e, n), i();
              },
            });
          else if (f) {
            var d = e.textContent;
  ...
  function u(t) {
    ...
    function w() {
      var e = i(/^@supports *([^{]+)/);
      if (e) return { type: "supports", supports: e[1].trim(), rules: _() };
    }
    function x() {
      if (i(/^@host\s*/)) return { type: "host", rules: _() };
    }
    function C() {
      var e = i(/^@media([^{]+)*/);
      if (e) return { type: "media", media: (e[1] || "").trim(), rules: _() };
    }
    function O() {
    ...
    function _(e) {
      ...
      for (
        var r, n = p();
        t.length && (e || "}" !== t[0]) && (r = k() || M());

      )
        r.type && n.push(r), (n = n.concat(p()));
      return e || l() ? n : c("missing '}'");
    }
    return { type: "stylesheet", stylesheet: { rules: _(!0), errors: a } };
  }
  function l(t) {
    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
    ...
    if (n) {
      if ("var" === n.pre.slice(-3)) {
        ...
        return a
          ...
          : n.pre.slice(0, -3) + o(n.body) + v(n.post, t);
      }
      return n.pre + "(".concat(v(n.body, t), ")") + v(n.post, t);
    }
    return (
      -1 !== e.indexOf("var(") &&
  ...
  var h = "undefined" != typeof window,
    y =
      h && window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"),
    g = { group: 0, job: 0 },
    b = {
      rootElement: h ? document : null,
      shadowDOM: !1,
  ...
  function j() {
    ...
    if (h) {
      if (s.watch) return (s.watch = b.watch), k(s), void j(s);
      if (
        (!1 === s.watch && x && (x.disconnect(), (x = null)), !s.__benchmark)
      ) {
        if (w === s.rootElement) return void M(r);
        if (
          ((s.__benchmark = V()),
          (s.exclude = [
            x
          ...
          if (
            ...
            var d = s.rootElement.querySelectorAll(
              '[data-cssvars]:not([data-cssvars="out"])'
            );
            d.length < C && ((C = d.length), (E.dom = {}));
          }
        }
      }
      if ("loading" !== document.readyState)
        if (y && s.onlyLegacy) {
          if (s.updateDOM) {
            ...
            Object.keys(s.variables).forEach(function (e) {
              m.style.setProperty(e, s.variables[e]);
            });
          }
        } else
          !A && (s.shadowDOM || s.rootElement.shadowRoot || s.rootElement.host)
            ? n({
                ...
                onComplete: function (e, t, r) {
                  l(e, { store: E.dom, onWarning: c }), (A = !0), j(s);
                },
              })
            : ((w = s.rootElement),
              n({
                ...
                onComplete: function (r, n) {
                  ...
                  if (
                    ...
                    e(E.job, E.dom),
                    s.updateDOM
                      ? (e(E.user, s.variables), e(E.job, E.user))
                      : (e(E.job, E.user, s.variables), e(i, s.variables)),
                    g.job > 0 &&
                      Boolean(
                        Object.keys(E.job).length > Object.keys(i).length ||
                          Boolean(
                            Object.keys(i).length &&
                              Object.keys(E.job).some(function (e) {
                                return E.job[e] !== i[e];
                              })
                          )
                      ))
                    ...
                    if (
                      ...
                      o.forEach(function (t) {
                        ...
                        if (t.__cssVars)
                          try {
                            p(
                              t.__cssVars.tree,
                              e({}, s, { variables: E.job, onWarning: c })
                            );
                      ...
                      (C = s.rootElement.querySelectorAll(
                        '[data-cssvars]:not([data-cssvars="out"])'
                      ).length),
                      s.shadowDOM)
                    )
                      for (
                        ...
                        if (
                          ...
                          var x = e({}, s, { rootElement: h.shadowRoot });
                          j(x);
                        }
                    s.updateDOM && v && _(s.rootElement),
                      (w = !1),
                      s.onComplete(
                        d.join(""),
                        m,
                        JSON.parse(JSON.stringify(E.job)),
                        V() - s.__benchmark
                      );
                  }
                },
        ...
        document.addEventListener("DOMContentLoaded", function e(t) {
          j(r), document.removeEventListener("DOMContentLoaded", e);
        });
    }
  }
  function k(e) {
    ...
    window.MutationObserver &&
      ...
      (x = new MutationObserver(function (r) {
        r.some(function (r) {
          var n,
            o = !1;
          return (
  ...
  function T(e, t) {
    return (
      (e.replace(S.cssComments, "").match(S.cssUrls) || []).forEach(function (
        r
      ) {
        var n = r.replace(S.cssUrls, "$1"),
          o = L(n, t);
  ...
  function V() {
    return h && (window.performance || {}).now
