!(function (t, e) {
  ...
  var I = null,
    b = function () {
      ...
      return (
        ...
        t.appendChild(e),
        (I = "10px" === window.getComputedStyle(e, null).width),
        t.removeChild(e),
        I
      );
    };
  ...
  function L(t) {
    return (
      !!w[t] &&
      (w[t].element.removeEventListener("transitionend", w[t].listener),
      (w[t] = null),
      !0)
    );
  }
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return Array.isArray(t)
                  ? this.options.filterMode === u.FilterMode.ANY
                    ? t.some(s)
                    : t.every(s)
                  : n.includes(t);
              },
            ...
            },
            {
              ...
              value: function (t) {
                return "function" == typeof this.options.gutterWidth
                  ...
                  : this.options.sizer
                  ? S(this.options.sizer, "marginLeft")
              ...
              value: function () {
                ...
                e && t && this.isInitialized
                  ...
                  ? (this._styleImmediately(this._queue),
                    this._dispatch(u.EventType.LAYOUT))
                  : this._dispatch(u.EventType.LAYOUT),
